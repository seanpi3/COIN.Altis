...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------*/
_debug =                   						1;    // 0:off  1:on  //If on shows markers for group position,type(units,vehicle,armor,air),number of units in the group and current waypoint 
																			// Also, will turn on debug messages
/*-----------------------------------------------------------------------------------------------------------------------------------------------------*/
//sets spawned units skill level can be an array.. [0.2,0.7]  or  0.2

_setskill_inf=                                                      [0.2,0.4]          ;    // sets skill for infantry units
_setskill_veh=                                                     	[0.3,0.5]          ;   	//sets skill for vehicles and armor units
...
_burydead =                                60 + random 60;            //set the delay in secs until units are removed, does not remove vehicles
...
_fillcargo =                                     [.5,1]   ;    //this is 50-100% full
...
call compile preprocessFileLineNumbers "addons\SLP\scripts\SLP_fnc_common.sqf";
call compile preprocessFileLineNumbers "addons\SLP\scripts\SLP_fnc_spawn.sqf";
SLP_units = compile preprocessfile "addons\SLP\SLP_units_config.sqf";
SLP_Task = compile preprocessfile "addons\SLP\SLP_Tasks.sqf";
SLP_spawn = compile preprocessfile "addons\SLP\scripts\SLP_spawn.sqf";
SHK_pos = compile preprocessfile "addons\SLP\scripts\SHK_pos.sqf";    
SHK_buildpos = compile preprocessfile "addons\SLP\scripts\SHK_buildingpos.sqf";
SLP_markers = compile preprocessfile "addons\SLP\scripts\SLP_markers.sqf";
