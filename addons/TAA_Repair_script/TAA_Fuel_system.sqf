...
TAA_Fuel_Containers_Action =
{
	...
	add6 = player addAction ["<t color=""#000000"">" + "Check Canister's Gasoline" + "</t>", "TAA_Repair_script\TAA_repair_handle_action.sqf", ["action_check_amount_Canister"], 10, true, true, "", "true"]; 
	add8 = player addAction ["<t color=""#FFA500"">" + "Refuel vehicle" + "</t>", "TAA_Repair_script\TAA_repair_handle_action.sqf", ["action_refuel"], 10, true, true, "", "call TAA_level_Tanker_check"];
	add9 = player addAction ["<t color=""#FFA500"">" + "Refill Canister" + "</t>", "TAA_Repair_script\TAA_repair_handle_action.sqf", ["action_refill"], 10, true, true, "", "call TAA_Refill_Check"];
	...
	while { true} do 
	{
		...
		_detection8 = nearestObjects [player, ["B_Truck_01_fuel_F","Land_MetalBarrel_F"], 5];
